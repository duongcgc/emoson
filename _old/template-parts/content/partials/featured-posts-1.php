                                                ...
                                                <div class="image">
                                                    <a href="<?php echo get_the_permalink(); ?>" title="slider">
                                                        <?php if (has_post_thumbnail()) : ?>
                                                            <image width="380" height="320" src="<?php the_post_thumbnail_url('gcod_thumbnail_post_380'); ?>" alt="<?php echo esc_html($cat_name); ?>" />
                                                        <?php else : ?>
                                                            <image width="380" height="320" src="<?php echo get_template_directory_uri() . '/assets/images/place-holder.jpg'; ?>" alt="<?php echo esc_html($cat_name); ?>" />
                                                        <?php endif; ?>
                                                    </a>
                                                </div>
