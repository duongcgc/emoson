...
if ( ! function_exists( 'gcod_pagination' ) ) {
	/**
	 ...
	 */
	function gcod_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'autumn-theme' ),
				'next_text'          => __( '&raquo;', 'autumn-theme' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'autumn-theme' ),
			)
		);
