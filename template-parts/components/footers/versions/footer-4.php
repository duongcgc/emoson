...
$gcod_elements_layout_postitions = array(
    ...
    'footer-main-left' => array(
        ...
        'close_tag'         => '</div>',
        'elements'          => array('element-footer-photo', 'element-footer-logo', 'element-site-info'),
        'seperator'         => false
    ),
    'footer-main-right' => array(
        'open_tag'          => '<div class="footer-main-right">',
        'close_tag'         => '</div></div>',
        'elements'          => array('element-footer-category', 'element-footer-social-icons', 'element-footer-tags', 'element-footer-lastposts'),
        'seperator'         => false
    ),
    'footer-info' => array(
