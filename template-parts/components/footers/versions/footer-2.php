...
$gcod_elements_layout_postitions = array(
    ...
    'footer-main-left' => array(
        ...
        'close_tag'         => '</div>',
        'elements'          => array('element-footer-logo', 'element-site-info','element-footer-social-icons'),
        'seperator'         => false
    ),
    'footer-main-right' => array(
        'open_tag'          => '<div class="footer-main-right">',
        'close_tag'         => '</div></div>',
        'elements'          => array('element-footer-menu', 'element-facebook-fanpage'),
        'seperator'         => false
    ),
    'footer-info' => array(
