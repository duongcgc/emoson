                                ...
                                <div class="item">
                                    <div class="post">
                                            ...
                                            <?php if (gcod_display_post_element_on_section('element-post-thumbnail')) : ?>
                                                ...
                                                <div class="image">
                                                    <a href="<?php echo get_the_permalink(); ?>" title="slider">
                                                        <image src="<?php the_post_thumbnail_url('gcod_thumbnail_post'); ?>" alt="<?php echo esc_html($cat_name); ?>" />
                                                    </a>
                                                </div>
                                        ...
                                        <div class="content">
                                            ...
                                            <?php if ((gcod_display_post_element_on_section('element-post-readmore')) || (gcod_display_post_element_on_section('element-post-share'))) : ?>
                                                ...
                                                <div class="post-button is-style-outline">
                                                    ...
                                                    <?php if (gcod_display_post_element_on_section('element-post-share')) : ?>
