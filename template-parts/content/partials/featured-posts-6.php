                                ...
                                <div class="item">
                                    <div class="post">
                                        ...
                                        <div class="content">
                                                ...
                                                <?php if (gcod_show_media_thumbnail_on_posts()) : ?>
                                                    ...
                                                    <div class="image">
                                                        <a href="<?php echo get_the_permalink(); ?>" title="slider">
                                                            <!-- <image src="<?php //the_post_thumbnail_url('full'); 
                                                                                ?>" alt="<?php //echo esc_html($cat_name); 
                                                                                            ?>" /> -->
                                            ...
                                            <?php if (gcod_display_post_element_on_section('element-post-except')) : ?>
